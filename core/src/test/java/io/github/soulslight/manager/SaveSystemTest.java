...
class SaveSystemTest {
    ...
    void testLoadFromBackup() {
        ...
        GameStateMemento validMemento = new GameStateMemento(new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), 123L, 1);
    ...
    void testBackupCreationOnSave() {
        ...
        // Primo salvataggio
        GameStateMemento m1 = new GameStateMemento(new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), 1L, 1);
        Mockito.when(mockModel.createMemento()).thenReturn(m1);
        saveManager.saveGame(mockModel);

        // Secondo salvataggio
        GameStateMemento m2 = new GameStateMemento(new ArrayList<>(), new ArrayList<>(), new ArrayList<>(), 2L, 2);
