...
public class LogHelper {
    ...
    /**
     * Logs a message only if it differs from the previously logged message.
     * This prevents log flooding from the game loop.
     *
    ...
    /**
     * Logs a message at most once every 'interval' seconds.
     * Useful for recurring events in the update loop (e.g. "Enemy Attacking").
     *
     * @param tag      The tag for the log entry.
     * @param message  The message to log.
