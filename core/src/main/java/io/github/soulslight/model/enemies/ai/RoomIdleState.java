...
/**
 * Pattern: State (Concrete State) Room-based idle state: enemies stay completely still until the
 * room activates combat. Unlike IdleState, this does NOT auto-detect players - activation is
 * controlled by Room.
 */
