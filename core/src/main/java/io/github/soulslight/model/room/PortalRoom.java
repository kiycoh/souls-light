...
/**
 * A special room variant that contains a portal for level completion.
 * Does not lock doors when player enters.
 * Spawns a Portal entity that requires player interaction.
 */
