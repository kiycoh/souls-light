...
/**
 * Pattern: Strategy (Abstract Strategy) Sealed interface for map generation
 * algorithms.
 */
public sealed interface MapGenerationStrategy
  ...
  /**
   * Returns room data for room-based gameplay (lock/unlock mechanics).
   * Default implementation returns empty list for strategies without discrete
   * rooms.
   *
