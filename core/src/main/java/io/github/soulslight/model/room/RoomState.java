...
/**
 * Pattern: State
 * Sealed interface for room lifecycle states.
 * Manages transitions between Passive, ActiveCombat, and Cleared states.
 */
public sealed interface RoomState
        permits PassiveState, ActiveCombatState, ClearedState {
