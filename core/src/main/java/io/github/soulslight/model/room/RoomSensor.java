...
/**
 * A Box2D sensor fixture that covers a room's interior.
 * Detects when Player enters the room to trigger state transitions.
 * The sensor is non-solid (isSensor = true) so entities pass through.
 */
public class RoomSensor {
    ...
    /**
     * Called when a player enters this sensor.
     * Delegates to the room's onPlayerEntered method.
     */
