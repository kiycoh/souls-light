...
public class ShielderAttack extends AbstractAttack {
    ...
    public void executeAttack(Entity attacker, List<Entity> targets) {
        ...
        Vector2 attackerPos = (attacker.getBody() != null) ? attacker.getBody().getPosition() : attacker.getPosition();
        Vector2 targetPos = (target.getBody() != null) ? target.getBody().getPosition() : target.getPosition();
