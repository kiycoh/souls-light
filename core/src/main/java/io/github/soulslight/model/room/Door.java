...
/**
 * Represents a door that can be locked/unlocked.
 * When locked, creates a static physics body to block passage.
 * When unlocked, removes the blocking body.
 */
public class Door {
