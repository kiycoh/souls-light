...
/**
 * Pattern: Factory Method Encapsulates the logic of creating levels based on level number and game
 * mode. Selects appropriate MapGenerationStrategy and enemy configuration.
 */
public class LevelFactory {
   ...
   */
  public static MapGenerationStrategy createStrategy(
      int levelNumber, GameMode gameMode, long seed) {
