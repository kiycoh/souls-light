...
public class GameHUD {
    ...
    /**
     * Costruttore per DEPENDENCY INJECTION (Usato nei Test).
     * Passando dei Mock qui, evitiamo il crash degli shader.
     */
    ...
    /**
     * Costruttore di DEFAULT (Usato nel Gioco reale).
     * Crea le istanze reali di ShapeRenderer e BitmapFont.
     */
    public GameHUD() {
